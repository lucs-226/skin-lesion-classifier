...
\begin{itemize}
    \item \textbf{Luca Santonocito:} Engineered the robust training strategy, implementing the Stratified K-Fold Cross-Validation, Weighted Random Sampler, and the custom Focal Loss. He also configured the optimization logic (AdamW, Scheduler) and the Test-Time Augmentation (TTA) module.
